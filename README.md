...
│       ├── agentgateway-crds.yaml     # Wave 2: AgentGateway CRDs v2026.6.0
│       ├── agentgateway-control-plane.yaml  # Wave 3: Control plane v2026.6.0
...
| **AgentGateway CRDs** | `enterprise-agentgateway-crds` | v2026.6.0 | Custom types: `AgentgatewayBackend`, `EnterpriseAgentgatewayPolicy` |
| **Control Plane** | `enterprise-agentgateway` | v2026.6.0 | Controller + proxy that processes Gateway API resources |
...
```bash
sed -i 's/v2026.6.0/v2026.6.1/g' argocd/apps/agentgateway-crds.yaml argocd/apps/agentgateway-control-plane.yaml
git add -A && git commit -m "Upgrade AgentGateway to v2026.6.1" && git push
```
